...
import OllamaChat from "../ollama/OllamaChat"; // Importa el componente OllamaChat
...
const RegistrarTransaccion = () => {
  ...
  return (
    <div className="d-flex">
        ...
        <main className="p-4 bg-light">
          ...
          <div className="card shadow-sm p-4 mb-4">
            <form onSubmit={handleSubmit} className="row g-3">
              ...
              {/* Subcuenta */}
              <div className="col-md-3">
                <label htmlFor="subcuenta" className="form-label">
                  Subcuenta
                </label>
                <select
                  id="subcuenta"
                ...
                >
                  <option value="">
                    {loadingSubcuentas
                      ...
                      : todasSubcuentas.length
                      ? "Selecciona una subcuenta"
                      : "Sin subcuentas"}
                  </option>
                  {todasSubcuentas.map((s) => (
              ...
              <table className="table table-bordered table-hover align-middle text-center">
                ...
                <tbody>
                  {transacciones.length === 0 && (
                    <tr>
                      <td colSpan={5} className="text-muted fst-italic py-3">
      ...
      {/* Agrega el componente OllamaChat aquí, fuera de otros contenedores para que sea flotante */}
      <OllamaChat />
    </div>
  );
};
