...
import { FaHeart, FaRegHeart, FaBars, FaCog, FaPlus, FaDownload } from 'react-icons/fa';
...
function Homepage() {
    ...
    const handleFavorito = (id) => {
        setEmpresas(empresas.map(empresa => 
            empresa.id === id ? {...empresa, favorita: !empresa.favorita} : empresa
        ));
    };
                        ...
                        <div className="d-flex flex-column h-100">
                            <nav className="mb-4">
                                ...
                                <div className="d-flex flex-column gap-2">
                                    {['Balance General', 'Libro Diario', 'Libro Mayor'].map((item) => (
                                        <button 
                                            key={item}
                ...
                <main className="flex-grow-1 p-4 bg-light">
                    ...
                    <div className="mb-4">
                        <div className="btn-group">
                            <button 
                                className={`btn ${vistaActual === 'Recientes' ? 'btn-primary' : 'btn-outline-primary'}`}
                                onClick={() => setVistaActual('Recientes')}
                            >
                                Recientes
                            </button>
                            <button 
                                className={`btn ${vistaActual === 'Todos' ? 'btn-primary' : 'btn-outline-primary'}`}
